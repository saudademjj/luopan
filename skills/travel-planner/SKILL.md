---
name: travel-planner
description: 旅游行程规划。用户提出任何旅行/出游/行程规划相关需求时使用——包括"帮我规划去XX的旅行""XX天去XX玩""带爸妈/孩子去XX""XX假期去哪儿"以及任何涉及目的地、天数、路线、行程安排的请求,即使没有明确说"规划"。覆盖自由行、家庭游、亲子游、商务出差等所有类型。产出包含逐日行程表、预算估算、交通住宿建议、景点美食清单。规划前必须联网查实时信息(航班、酒店、景点开放时间、天气、签证),并必须询问预算。
compatibility: WebSearch/WebFetch 用于查询实时信息;无联网时需明确声明信息可能过期
---
